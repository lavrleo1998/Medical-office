...
{
    public partial class ter_rasp : Form
    {
        ...
        public ter_rasp(string per)
        {
            InitializeComponent();
            this.per_nazn_login_sotrudnika = per;
        }

        private void ter_rasp_Load(object sender, EventArgs e)
        {
        ...
        {
            this.Hide();
            ter ter_raspform = new ter(textBox_enter_nazn.Text, per_nazn_login_sotrudnika);
            ter_raspform.Show();
        }
    }
}
